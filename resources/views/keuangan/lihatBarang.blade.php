					...
					<table id="data-table" class="table table-striped table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td align="center"><a href="{{url('keuangan/dialogDetailBarang',$row->kdbarang)}}" data-toggle="modal" data-target="#myModal" class="btn-primary btn-sm">Detail <i class="fa fa-angle-double-right"></i></a></td>
							</tr>
							@endforeach
						</tbody>
					</table>
