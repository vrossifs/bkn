...
<body>	
	...
	$pengajuan = DB::table('notif_khusus')
		->select('*', DB::raw('notif_khusus.tanggal AS tgl_notifikasi'))
		->join('unit_kerja', 'notif_khusus.penerima', '=', 'unit_kerja.kode_unit')
		->join('transaksi', 'notif_khusus.pengirim', '=', 'transaksi.kdtransaksi')
		->where('penerima', session('kode_unit'))
		->where('notif_khusus.status', 6)
		->groupBy('kdnotif')
		->orderBy('notif_khusus.tanggal', 'desc')
		->limit(2)->get();
	...
	<div id="header" class="header navbar navbar-default navbar-fixed-top">
		...
		<div class="container-fluid">
			...
			<div class="navbar-header">
				<a href="{{url('keuangan/index')}}" class="navbar-brand"><img src="{{ asset('/img/login-bg/logo.png') }}" style="width: 50%"></a>
			</div>
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
					<a href="javascript:;" data-toggle="dropdown" class="dropdown-toggle f-s-14">
						...
						<span class="label">{{sizeof($notifikasi)+sizeof($pengajuan)}}</span>
					</a>
					<ul class="dropdown-menu media-list pull-right animated fadeInDown">
						<li class="dropdown-header">Notifikasi Pengajuan</li>
						<?php 
						foreach ($pengajuan as $key) { ?>
							<li class="media">
								<a href="{{url('keuangan/approvalBeli')}}">
						...
						foreach ($notifikasi as $key) { ?>
							<li class="media">
								<a href="{{url('keuangan/notifikasi',$key->kdnotifikasi)}}">
									<div class="media-body">
										<h6 class="media-heading">{{$key->header}}</h6>
										<p><?php echo $key->pesan;?></p>
						...
						<li class="dropdown-footer text-center">
                            <a href="{{url('keuangan/notifikasi', 'all')}}">View more</a>
                        </li>
					</ul>
				</li>
	...
	<div id="sidebar" class="sidebar">
		...
		<div data-scrollbar="true" data-height="100%">
			...
			<!-- begin sidebar nav -->
			<ul class="nav">
				<li><a href="{{url('keuangan/index')}}"><i class="fa fa-laptop"></i> <span>Dashboard</span></a></li>
				<li><a href="{{url('keuangan/lihatBarang')}}"><i class="fa fa-eye"></i> <span>Lihat Barang</span></a></li>
				<li><a href="{{url('keuangan/beliBarang')}}"><i class="fa fa-pencil"></i> <span>Input Beli Barang</span></a></li>
				<li><a href="{{url('keuangan/ambilBarang')}}"><i class="fa fa-pencil"></i> <span>Input Ambil Barang</span></a></li>
				<li><a href="{{url('keuangan/approvalBeli')}}"><i class="fa fa-check"></i> <span>Approval Beli Barang</span></a></li>
				<li class="has-sub">
					<a href="javascript:;">
					...
					<ul class="sub-menu">
						<li><a href="{{url('keuangan/lihatLaporanTahunan')}}">Laporan Tahunan</a></li>
						<li><a href="{{url('keuangan/lihatLaporanBulanan')}}">Laporan Bulanan</a></li>
					</ul>
				</li>
				<li><a href="{{url('keuangan/riwayatTambahBarang')}}"><i class="fa fa-history"></i> <span>Riwayat Tambah Barang</span></a></li>
			</ul>
			<!-- end sidebar nav -->
		</div>
