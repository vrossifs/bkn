...
@section('content')
	...
	<ol class="breadcrumb pull-right">
		<li><a href="{{url('kepala/index')}}">Home</a></li>
		<li class="active">Lihat Laporan</li>
	</ol>
	<!-- end breadcrumb -->
	<h1 class="page-header m-b-10">Lihat Laporan</h1><hr />
	<!-- begin row -->
	<div class="row">
		<!-- begin col-12 -->
		<div class="col-md-12">
					...
					<table id="data-table" class="table table-striped table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td align="center"><a href="{{url('kepala/priviewKtu',1)}}" class="btn btn-outline btn-circle btn-sm purple"><i class="fa fa-edit"></i> Priview </a></td>
							</tr>
							<tr>
								<td align="center">{{'00002'}}</td>
								<td align="center">{{'SUB.BAG PERENCANAAN DAN KEUANGAN'}}</td>
								<td align="center">{{$keuangan}}</td>
								<td align="center"><a href="{{url('kepala/priviewKtu',2)}}" class="btn btn-outline btn-circle btn-sm purple"><i class="fa fa-edit"></i> Priview </a></td>
							</tr>
							<tr>
								<td align="center">{{'00003'}}</td>
								<td align="center">{{'SUB.BAG UMUM'}}</td>
								<td align="center">{{$umum}}</td>
								<td align="center"><a href="{{url('kepala/priviewKtu',3)}}" class="btn btn-outline btn-circle btn-sm purple"><i class="fa fa-edit"></i> Priview </a></td>
							</tr>
							<tr>
								<td align="center">{{'00004'}}</td>
								<td align="center">{{'SUB.BAG KEPEGAWAIAN'}}</td>
								<td align="center">{{$peg4}}</td>
								<td align="center"><a href="{{url('kepala/priviewKtu',4)}}" class="btn btn-outline btn-circle btn-sm purple"><i class="fa fa-edit"></i> Priview </a></button></td>
							</tr>
							<tr>
								<td align="center">{{'00005'}}</td>
								<td align="center">{{'SEKSI VERIVIKASI & PELAPORAN MUTASI & STATUS KEPEGAWAIAN'}}</td>
								<td align="center">{{$peg5}}</td>
								<td align="center"><a href="{{url('kepala/priviewKtu',5)}}" class="btn btn-outline btn-circle btn-sm purple"><i class="fa fa-edit"></i> Priview </a></td>
							</tr>
							<tr>
								<td align="center">{{'00006'}}</td>
								<td align="center">{{'SEKSI MUTASI INSTANSI VERIVIKASI & PROVINSI'}}</td>
								<td align="center">{{$peg6}}</td>
								<td align="center"><a href="{{url('kepala/priviewKtu',6)}}" class="btn btn-outline btn-circle btn-sm purple"><i class="fa fa-edit"></i> Priview </a></td>
							</tr>
							<tr>
								<td align="center">{{'00007'}}</td>
								<td align="center">{{'SEKSI MUTASI INSTANSI KAB/KOTA'}}</td>
								<td align="center">{{$peg7}}</td>
								<td align="center"><a href="{{url('kepala/priviewKtu',7)}}" class="btn btn-outline btn-circle btn-sm purple"><i class="fa fa-edit"></i> Priview </a></td>
							</tr>
							<tr>
								<td align="center">{{'00008'}}</td>
								<td align="center">{{'SEKSI STATUS KEPEGAWAIAN'}}</td>
								<td align="center">{{$peg8}}</td>
								<td align="center"><a href="{{url('kepala/priviewKtu',8)}}" class="btn btn-outline btn-circle btn-sm purple"><i class="fa fa-edit"></i> Priview </a></td>
							</tr>
							<tr>
								<td align="center">{{'00009'}}</td>
								<td align="center">{{'SEKSI VERIVIKASI & PELAPORAN PENGANGKATAN & PENSION'}}</td>
								<td align="center">{{$peg9}}</td>
								<td align="center"><a href="{{url('kepala/priviewKtu',9)}}" class="btn btn-outline btn-circle btn-sm purple"><i class="fa fa-edit"></i> Priview </a></td>
							</tr>
							<tr>
								<td align="center">{{'00010'}}</td>
								<td align="center">{{'SEKSI PENSION PEGAWAI NEGERI SIPIL INSTANSI KAB/KOTA'}}</td>
								<td align="center">{{$peg10}}</td>
								<td align="center"><a href="{{url('kepala/priviewKtu',10)}}" class="btn btn-outline btn-circle btn-sm purple"><i class="fa fa-edit"></i> Priview </a></td>
							</tr>
							<tr>
								<td align="center">{{'00011'}}</td>
								<td align="center">{{'SEKSI PENGANGKATAN APARATUR SIPIL NEGARA'}}</td>
								<td align="center">{{$peg11}}</td>
								<td align="center"><a href="{{url('kepala/priviewKtu',11)}}" class="btn btn-outline btn-circle btn-sm purple"><i class="fa fa-edit"></i> Priview </a></td>
							</tr>
							<tr>
								...
								<td align="center"><a href="{{url('kepala/priviewKtu',12)}}" class="btn btn-outline btn-circle btn-sm purple"><i class="fa fa-edit"></i> Priview </a></td>
							</tr>
							<tr>
								<td align="center">{{'00013'}}</td>
								<td align="center">{{'SEKSI PENGELOLAAN ARSIP KEPEGAWAIAN INSTANSI KAB/KOTA'}}</td>
								<td align="center">{{$peg13}}</td>
								<td align="center"><a href="{{url('kepala/priviewKtu',13)}}" class="btn btn-outline btn-circle btn-sm purple"><i class="fa fa-edit"></i> Priview </a></td>
							</tr>
							<tr>
								...
								<td align="center"><a href="{{url('kepala/priviewKtu',14)}}" class="btn btn-outline btn-circle btn-sm purple"><i class="fa fa-edit"></i> Priview </a></td>
							</tr>
							<tr>
								<td align="center">{{'00015'}}</td>
								<td align="center">{{'SEKSI PEMANFAATAN TEKNOLOGI & INFORMASI'}}</td>
								<td align="center">{{$peg15}}</td>
								<td align="center"><a href="{{url('kepala/priviewKtu',15)}}" class="btn btn-outline btn-circle btn-sm purple"><i class="fa fa-edit"></i> Priview </a></td>
							</tr>
							<tr>
								<td align="center">{{'00016'}}</td>
								<td align="center">{{'SEKSI FASILITAS KINERJA'}}</td>
								<td align="center">{{$peg16}}</td>
								<td align="center"><a href="{{url('kepala/priviewKtu',16)}}" class="btn btn-outline btn-circle btn-sm purple"><i class="fa fa-edit"></i> Priview </a></td>
							</tr>
							<tr>
								<td align="center">{{'00017'}}</td>
								<td align="center">{{'SEKSI SUPERVISE KEPEGAWAIAN'}}</td>
								<td align="center">{{$peg17}}</td>
								<td align="center"><a href="{{url('kepala/priviewKtu',17)}}" class="btn btn-outline btn-circle btn-sm purple"><i class="fa fa-edit"></i> Priview </a></td>
							</tr>
						</tbody>
					</table>
				</div>
